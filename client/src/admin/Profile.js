...
const UserDetails = () => {
    ...
    const getdata = async () => {
        ...
        const res = await fetch(`/api/admin/adminprofile/${token}`, {
            method: "GET",
            headers: {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div className="add_btn" align="center">
                                                    <NavLink to={`/adminedit/${token}`}> <button className="btn btn-primary" >edit</button></NavLink>
                                                </div>
                                            </td>
                                            <td>
                                                <div className="add_btn" align="center">
                                                    <NavLink to={`/adminimage/${token}`}> <button className="btn btn-primary" >change image</button></NavLink>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
