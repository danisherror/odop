...
const Addimage = () => {
    ...
    const updateimage = async (e) => {
        ...
        const res2 = await fetch(`/api/admin/adminimageadd/${token}`, {
            method: "PATCH",
            headers: {
        ...
        <div className="container">
            ...
            <form className="mt-4">
                <div className="row">
                    ...
                    <button type="submit" onClick={updateimage} class="btn btn-primary">Submit</button>
                </div>
            </form>
        </div>
        </>
